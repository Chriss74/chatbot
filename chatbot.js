...
//eggrafa
  ...
  //arxh
  var find=['έρθω στο δικαστήριο', 'έρθω στα δικαστήρια','βρω στο δικαστήριο', 'βρω τα δικαστήρια','φθάσω στο δικαστηριο','φθάσω στα δικαστήρια', 'πού πρέπει να πάω', 'πού να πάω', 'πού είναι το δικαστήριο', 'πού είναι τα δικαστήρια', 'πού βρίσκεται το δικαστήριο', 'πού βρίσκονται τα δικαστήρια', 'πού καταθέτω', 'πού θα καταθέσω', 'πού μπορώ να καταθέσω', 'πού να καταθέσω', 'πώς πάω στο δικαστήριο', 'πώς πάω στα δικαστηρια', 'πώς θα πάω στο δικαστήριο', 'πώς θα πάω στα δικαστήρια', 'πώς να πάω στο δικαστήριο', 'πώς να πάω στα δικαστηρια', 'που θα καταθέσω', 'που βρίσκεται' ]
  var entitled1=['δικαιούμαι', 'δικαιούται', 'μπορώ να', 'μπορεί να', 'προϋποθέσεις']
  var entitled2=['να λάβω', 'να λάβει', 'να πάρει', 'να πάρω', 'να μου δώσουν', 'νομική βοήθεια', 'ευεργέτημα πενίας']
